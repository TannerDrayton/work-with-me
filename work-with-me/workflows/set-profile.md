<purpose>
Switch the model profile used by WWM agents. Controls which Claude model each agent uses, balancing quality vs token spend.
</purpose>
...
[Show table from MODEL_PROFILES in wwm-tools.js for selected profile]
