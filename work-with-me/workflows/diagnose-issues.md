...
```bash
node ~/.claude/work-with-me/bin/wwm-tools.js commit "docs({phase}): add root causes from diagnosis" --files ".planning/phases/XX-name/{phase}-UAT.md"
```
</step>
