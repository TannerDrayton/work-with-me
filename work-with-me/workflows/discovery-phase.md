...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /wwm:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/work-with-me/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/work-with-me/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/work-with-me/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/work-with-me/templates/discovery.md
...
Use ~/.claude/work-with-me/templates/discovery.md.
...
1. Discuss phase context (/wwm:discuss-phase [current-phase])
2. Create phase plan (/wwm:plan-phase [current-phase])
