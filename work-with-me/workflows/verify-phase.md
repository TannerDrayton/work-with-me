...
<required_reading>
@~/.claude/work-with-me/references/verification-patterns.md
@~/.claude/work-with-me/templates/verification-report.md
</required_reading>
...
Use wwm-tools to extract must_haves from each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  MUST_HAVES=$(node ~/.claude/work-with-me/bin/wwm-tools.js frontmatter get "$plan" --field must_haves)
...
Use wwm-tools for artifact verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  ARTIFACT_RESULT=$(node ~/.claude/work-with-me/bin/wwm-tools.js verify artifacts "$plan")
...
Use wwm-tools for key link verification against must_haves in each PLAN:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  LINKS_RESULT=$(node ~/.claude/work-with-me/bin/wwm-tools.js verify key-links "$plan")
...
See ~/.claude/work-with-me/templates/verification-report.md for complete template.
</step>
