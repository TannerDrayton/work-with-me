 ...
 *
 * Usage: node wwm-tools.js <command> [args] [--raw]
 *
 * Atomic Commands:
...
const MODEL_PROFILES = {
  'wwm-planner':              { quality: 'opus', balanced: 'opus',   budget: 'sonnet' },
  'wwm-roadmapper':           { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'wwm-executor':             { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'wwm-phase-researcher':     { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'wwm-project-researcher':   { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'wwm-research-synthesizer': { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'wwm-debugger':             { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'wwm-codebase-mapper':      { quality: 'sonnet', balanced: 'haiku', budget: 'haiku' },
  'wwm-verifier':             { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'wwm-plan-checker':         { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
  'wwm-integration-checker':  { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
};
...
function cmdInitExecutePhase(cwd, phase, includes, raw) {
  ...
  const result = {
    // Models
    executor_model: resolveModelInternal(cwd, 'wwm-executor'),
    verifier_model: resolveModelInternal(cwd, 'wwm-verifier'),
...
function cmdInitPlanPhase(cwd, phase, includes, raw) {
  ...
  const result = {
    // Models
    researcher_model: resolveModelInternal(cwd, 'wwm-phase-researcher'),
    planner_model: resolveModelInternal(cwd, 'wwm-planner'),
    checker_model: resolveModelInternal(cwd, 'wwm-plan-checker'),
...
function cmdInitNewProject(cwd, raw) {
  ...
  const result = {
    // Models
    researcher_model: resolveModelInternal(cwd, 'wwm-project-researcher'),
    synthesizer_model: resolveModelInternal(cwd, 'wwm-research-synthesizer'),
    roadmapper_model: resolveModelInternal(cwd, 'wwm-roadmapper'),
...
function cmdInitMapCodebase(cwd, raw) {
  ...
  const result = {
    // Models
    mapper_model: resolveModelInternal(cwd, 'wwm-codebase-mapper'),
...
async function main() {
  ...
  if (!command) {
    error('Usage: wwm-tools <command> [args] [--raw]\nCommands: state, resolve-model, find-phase, commit, verify-summary, verify, frontmatter, template, generate-slug, current-timestamp, list-todos, verify-path-exists, config-ensure-section, init');
  }
