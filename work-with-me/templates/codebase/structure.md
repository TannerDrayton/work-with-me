...
│   └── wwm/           # WWM-specific commands
├── work-with-me/     # Skill resources
...
**New Template:**
- Implementation: `work-with-me/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `work-with-me/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/work-with-me/workflows/{name}.md`

**New Reference Document:**
- Implementation: `work-with-me/references/{name}.md`
