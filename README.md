...
[![npm version](https://img.shields.io/npm/v/work-with-me?style=for-the-badge&logo=npm&logoColor=white&color=CB3837)](https://www.npmjs.com/package/work-with-me)
[![GitHub stars](https://img.shields.io/github/stars/triddle/work-with-me?style=for-the-badge&logo=github&color=181717)](https://github.com/triddle/work-with-me)
[![License](https://img.shields.io/badge/license-MIT-blue?style=for-the-badge)](LICENSE)

<br>

```bash
npx work-with-me@latest
```
...
*"Finally, a system that works WITH me, not FOR me."*

*"I understand what's happening now - Claude isn't just doing things, we're building together."*

*"The collaborative checkpoints and transparent planning make me feel like I'm actually in control."*

<br>

**For developers who want to work alongside AI, not just delegate to it.**

[Why This Approach](#why-this-approach) · [How It Works](#how-it-works) · [Commands](#commands) · [Philosophy](#philosophy)
...
GSD is amazing for autonomous execution - describe what you want, let Claude build it. But I wanted collaboration, not delegation. I want to understand what's being built, make decisions along the way, and learn from the process.
...
```bash
# Claude Code
npx work-with-me --claude --global   # Install to ~/.claude/
npx work-with-me --claude --local    # Install to ./.claude/

# OpenCode
npx work-with-me --opencode --global # Install to ~/.opencode/
npx work-with-me --opencode --local  # Install to ./.opencode/

# Gemini CLI
npx work-with-me --gemini --global   # Install to ~/.gemini/
npx work-with-me --gemini --local    # Install to ./.gemini/

# Install to all runtimes
npx work-with-me --all --global
npx work-with-me --all --local
```
</details>
