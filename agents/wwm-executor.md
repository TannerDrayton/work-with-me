...
```bash
INIT=$(node ~/.claude/work-with-me/bin/wwm-tools.js init execute-phase "${PHASE}")
```
...
**See @~/.claude/work-with-me/references/checkpoints.md**
...
**Use template:** @~/.claude/work-with-me/templates/summary.md
...
<state_updates>
After SUMMARY.md, update STATE.md using wwm-tools:
...
<final_commit>
```bash
node ~/.claude/work-with-me/bin/wwm-tools.js commit "docs({phase}-{plan}): complete [plan-name] plan" --files .planning/phases/XX-name/{phase}-{plan}-SUMMARY.md .planning/STATE.md
```
