---
name: wwm-roadmapper
description: Creates project roadmaps with phase breakdown, requirement mapping, success criteria derivation, and coverage validation. Spawned by /wwm:new-project orchestrator.
...
<downstream_consumer>
Your ROADMAP.md is consumed by `/wwm:plan-phase` which uses it to:
...
Use template from `~/.claude/work-with-me/templates/roadmap.md`.
...
Use template from `~/.claude/work-with-me/templates/state.md`.
